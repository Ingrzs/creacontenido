// @ts-nocheck
// FIX: Declare html2canvas and JSZip to inform TypeScript that they are available globally.
declare var html2canvas: any;
declare var JSZip: any;

// html2canvas y JSZip se cargan desde el CDN en index.html, por lo que asumimos que están disponibles globalmente.
